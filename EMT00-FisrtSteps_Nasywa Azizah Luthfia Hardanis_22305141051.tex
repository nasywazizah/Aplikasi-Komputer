...
\end{eulercomment}
\eulerimg{22}{images/EMT00-FisrtSteps_Nasywa Azizah Luthfia Hardanis_22305141051-004.png}
\eulersubheading{}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  -3.61155549868
\end{euleroutput}
\eulerheading{Menampilkan Daftar Variabel}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT00-FisrtSteps_Nasywa Azizah Luthfia Hardanis_22305141051-007-large.png}
\begin{eulerprompt}
>$&solve(a*x^2+b*x+c,x) // rumus abc
\end{eulerprompt}
\begin{eulerformula}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT00-FisrtSteps_Nasywa Azizah Luthfia Hardanis_22305141051-010-large.png}
...
\begin{eulerformula}
\[
\left[ x=\frac{3}{5} , x=1 \right] 
\]
\end{eulerformula}
\eulerimg{0}{images/EMT00-FisrtSteps_Nasywa Azizah Luthfia Hardanis_22305141051-012-large.png}
\eulerimg{1}{images/EMT00-FisrtSteps_Nasywa Azizah Luthfia Hardanis_22305141051-013-large.png}
\begin{eulercomment}
