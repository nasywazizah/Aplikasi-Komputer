...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-003.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-004.png}
\eulersubheading{}
\begin{eulercomment}
2. Gambar segitiga dengan titik-titik sudut ketiga titik singgung
tersebut. Merupakan segitiga apakah itu?
...
>plotSegment(A,C,"b"): // b=AC
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-005.png}
\begin{eulercomment}
...
>plotSegment(A,D):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-007.png}
\begin{eulerprompt}
>n=angleBisector(A,B,C);
>color(10); plotLine(n); color(1);
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segitiga ABC"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-008.png}
\eulersubheading{}
\begin{eulercomment}
5. Gambar jari-jari lingkaran dalam.
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-009.png}
\eulersubheading{}
\begin{eulercomment}
6. Hitung luas lingkaran luar dan luas lingkaran dalam segitiga ABC.
Adakah hubungan antara luas kedua lingkaran tersebut dengan luas
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-024.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-026.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-031.png}
\begin{eulerprompt}
>remvalue x,y,a,b,c
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-064.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-069.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-071.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-072.png}
\begin{eulerprompt}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-077.png}
\begin{eulercomment}
Tentu,
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-086.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-107.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-112.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-115.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-119.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-121.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-123.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-124.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-125.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-126.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-128.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-129.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-130.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-131.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-132.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-136.png}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-137.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-138.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-139.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-140.png}
...
>plotSegment(D,A,""):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-141.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-142.png}
\eulersubheading{}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-143.png}
\begin{eulerprompt}
...
>plotPoint(P,"P"); plotPoint(Q,"Q"); plotPoint(R,"R"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-144.png}
\eulersubheading{}
\begin{eulercomment}
...
>plotSegment(D,A,""):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-145.png}
\begin{eulerprompt}
>l=angleBisector(A,B,C);
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-146.png}
\begin{eulerprompt}
>r=norm(P-projectToLine(P,lineThrough(A,B)))
\end{eulerprompt}
\begin{euleroutput}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-147.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-148.png}
\begin{eulerprompt}
>plot3d("d2",xmin=-4,xmax=4,ymin=-3,ymax=3):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-149.png}
\begin{eulerprompt}
>plot2d("abs(x+2)+abs(x-2)", xmin=-5, xmax=5):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-150.png}
\eulersubheading{}
\begin{eulercomment}
...
>fcontour("d2",xmin=-5,xmax=5,ymin=-3,ymax=3,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-151.png}
\begin{eulerprompt}
>plot3d("d2",xmin=-4,xmax=4,ymin=-3,ymax=3):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-152.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-4,xmax=4):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Nasywa Azizah Luthfia Hardanis_22305141051-153.png}
\end{eulernotebook}
\end{document}
